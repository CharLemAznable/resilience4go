		...
		testCases: []*metricTestCase{
			{
				...
				desc: `Desc{fqName: "resilience4go_retry_calls", help: "The number of calls with/without retry", constLabels: {kind="successful_without_retry",name="test"}, variableLabels: {}}`,
				metric: &dto.Metric{
					Label: []*dto.LabelPair{
			...
			},
			{
				...
				desc: `Desc{fqName: "resilience4go_retry_calls", help: "The number of calls with/without retry", constLabels: {kind="successful_with_retry",name="test"}, variableLabels: {}}`,
				metric: &dto.Metric{
					Label: []*dto.LabelPair{
			...
			},
			{
				...
				desc: `Desc{fqName: "resilience4go_retry_calls", help: "The number of calls with/without retry", constLabels: {kind="failed_without_retry",name="test"}, variableLabels: {}}`,
				metric: &dto.Metric{
					Label: []*dto.LabelPair{
			...
			},
			{
				...
				desc: `Desc{fqName: "resilience4go_retry_calls", help: "The number of calls with/without retry", constLabels: {kind="failed_with_retry",name="test"}, variableLabels: {}}`,
				metric: &dto.Metric{
					Label: []*dto.LabelPair{
